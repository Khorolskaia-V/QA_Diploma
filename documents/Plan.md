...
##### 43. Вводим в поле `Владелец` фамилию и имя при помощи цифр во вкладке `Купить`
...
##### 51. Валидация неполного заполнения поля `CVC/CVV` во вкладке `Купить`
...
##### 52. Валидация неполного заполнения поля `CVC/CVV` во вкладке `Купить в кредит`
